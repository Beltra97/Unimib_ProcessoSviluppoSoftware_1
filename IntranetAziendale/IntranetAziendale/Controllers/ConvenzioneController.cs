...
namespace IntranetAziendale.Controllers
{
    ...
    [ApiController]
    public class ConvenzioneController : ControllerBase
    {
        ...
        [Route("Add")]
        [HttpPost]
        public IActionResult Add(RequestAddConvenzione request)
        {
        ...
        [Route("Update/{id}")]
        [HttpPut]
        public IActionResult Update(int id, RequestAddConvenzione request)
        {
